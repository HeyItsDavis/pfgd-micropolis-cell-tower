	...
	implements Micropolis.Listener, EarthquakeListener
{
	...
	public MainWindow(Micropolis engine)
	{
		...
		overlaysMenu.add(makeMapStateMenuItem("menu.overlays.CELLSERVICE_OVERLAY", MapState.CELLSERVICE_OVERLAY));
	...
	private JToolBar makeToolbar()
	{
		...
		//Add the CELL_TOWER icon to the tool bar
		c.gridy++;
		Box b7 = new Box(BoxLayout.X_AXIS);
		gridBox.add(b7,c);
		b7.add(makeToolBtn(MicropolisTool.CELL_TOWER));
